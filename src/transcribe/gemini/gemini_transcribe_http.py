...
from src.provider.provider_settings import get_float as ps_get_float
from src.provider.provider_settings import get_prompt as ps_get_prompt
from src.provider.provider_settings import get_str as ps_get_str
...
def get_timeout_seconds() -> float:
    raw = ps_get_float("timeout_seconds", env="GEMINI_TIMEOUT_SECONDS", default=30.0)
    try:
